...
- Import the existing flake at `https://github.com/Larusso/oh-my-claudecode-flake` as an independent helper flake under `flakes/oh-my-cloudecode/`, renaming its public-facing identifiers from `claudecode` to `cloudecode`.
